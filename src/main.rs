...
impl ForestRuntime {
    fn new(inptprogram: &[ForestInstruction]) -> Self {
        ForestRuntime {
            stack: vec![],
    ...
    fn step(&mut self) -> Result<(), ForestError> {
    ...
    fn dump(&self) -> Result<(), ForestDumpError> {
        println!("Stack: ");
